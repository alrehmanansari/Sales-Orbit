...
async function run() {
  ...
  // ── Leads ──────────────────────────────────────────────────────────────────
  // Each row includes created_at as the last element so date filters work correctly.
  const leads = [
    ['LD-20260218-1001','Sarah Mitchell','NexaTech Solutions','nexatech.io','sarah@nexatech.io','5551234567','New York','Cold Outreach','IT Services','IT Services','Alice Johnson','Hot','Interested in cross-border payments','Qualified','Alice Johnson','2026-02-18 09:00:00'],
    ['LD-20260301-1002','James Wei','CloudBridge Inc','cloudbridge.com','james@cloudbridge.com','5559876543','San Francisco','Customer Referral','B2B Seller','Software Development','Bob Martinez','Warm','','Contacted','Bob Martinez','2026-03-01 10:00:00'],
    ['LD-20260310-1003','Priya Kapoor','TradeLink B2B','tradelink.in','priya@tradelink.in','5554445555','Mumbai','Customer Referral','B2B Seller','B2B Goods','Clara Singh','Hot','High volume FX requirements','Qualified','Clara Singh','2026-03-10 11:00:00'],
    ['LD-20260416-1004','Liam Chen','CloudStack Systems','cloudstack.dev','liam@cloudstack.dev','5557778888','Singapore','Others','IT Services','IT Services','David Kim','Cold','Met at SaaS Expo','New','David Kim','2026-04-16 09:00:00'],
    ['LD-20260418-1005','Amina Hassan','Zarif Logistics','zarif.ae','amina@zarif.ae','5553332222','Dubai','Online Directory','B2B Seller','Logistics','Alice Johnson','Hot','Fleet of 200+ drivers','Qualified','Alice Johnson','2026-04-18 14:00:00'],
  ];
  for (const l of leads) {
    await pool.query(
      `INSERT INTO leads (lead_id,contact_person,company_name,website,email,phone,city,
       lead_source,vertical,nature_of_business,lead_owner,priority,notes,status,created_by,created_at)
       VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`, l
    );
  }
  ...
  await pool.query(
    `INSERT INTO opportunities
      (opportunity_id,lead_id,opportunity_name,company_name,contact_person,email,phone,city,
       ...
       decision_maker,competitors,deal_notes,stage,created_by,created_at)
     VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
